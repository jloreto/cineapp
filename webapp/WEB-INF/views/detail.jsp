		...
		<div class="container theme-showcase" role="main">
			...
			<div class="container marketing">
				...
				<div class="row">
					<div class="col-sm-3">
						<p class="text-center">
							<img class="img-rounded" src="${publicUrl }/images/${movie.image }" alt="Generic placeholder image" width="155" height="220">            
						</p>
					</div>
					<div class="col-sm-9">
						<div class="panel panel-default">
							...
							<div class="panel-body">                           
								<p>
									Original title : ${movie.title } <br>
									Actores : - <br>
									Director:  -  <br>                  
									Classificación: ${movie.classification }<br>
